...
const SignUp = () => {
  ...
  return (
    <div className=' '>
      <div className='w-[300px] sm:w-[668px] lg:w-[768px]   relative max-w-[100%] sm:min-h-[480px] min-h-[520px] bg-white shadow-2xl overflow-hidden' id="container">
      <ToastContainer />
        <div className="absolute top-0 h-[100%] w-[0%] sm:w-[50%] translate-x-full">
          <form onSubmit={handleSubmit} className='flex align-middle h-[100%] px-[40px] content-center justify-center flex-col'>
            ...
            <input className=' bg-slate-100 border-none my-[8px] mx-0 py-[10px] px-[15px] rounded-md text-[13px] w-[100%] outline-transparent' type="text" placeholder="Name" name='name' required />
            <PhoneInput country={"in"} value={phone} onChange={setPhone} placeholder='Phone' specialLabel=''/>
            <input className=' bg-slate-100 border-none my-[8px] mx-0 py-[10px] px-[15px] rounded-md text-[13px] w-[100%] outline-transparent'  type="email" placeholder="Email" name='email' required />
