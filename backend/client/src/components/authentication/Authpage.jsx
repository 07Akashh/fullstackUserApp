      ...
      <ToastContainer />
        <div className="absolute top-0 h-[100%] w-[0%] sm:w-[50%] translate-x-full">
          <form onSubmit={handleSubmit} className='flex align-middle h-[100%] px-[40px] content-center justify-center flex-col'>
            ...
            <button  className=' sm:self-center bg-blue-500 text-white rounded-xl hover:bg-blue-600 text-[8px] w-[220px]  py-2.5 px-10 font-bold uppercase cursor-pointer mt-5' type='submit'>Verify Otp</button>
          </form>
        </div>
